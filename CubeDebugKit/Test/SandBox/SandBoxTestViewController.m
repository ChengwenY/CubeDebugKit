...
@interface SandBoxTestViewController ()



@end

@implementation SandBoxTestViewController
...
- (void)viewDidLoad {
    ...
    UIButton *btn2 = [[UIButton alloc] initWithFrame:CGRectMake(0, btn1.cube_bottom+20, self.view.cube_width, 60)];
    ...
    UIButton *btn3 = [[UIButton alloc] initWithFrame:CGRectMake(0, btn2.cube_bottom+20, self.view.cube_width, 60)];
    ...
    UIButton *btn4 = [[UIButton alloc] initWithFrame:CGRectMake(0, btn3.cube_bottom+20, self.view.cube_width, 60)];
    ...
    UIButton *btn5 = [[UIButton alloc] initWithFrame:CGRectMake(0, btn4.cube_bottom+20, self.view.cube_width, 60)];
...
- (void)addImageFile{
    UIImage *image2 = [UIImage imageNamed:@"img.jpg"];
    NSString *path_document = NSHomeDirectory();
    NSString *imagePath = [path_document stringByAppendingString:@"/Documents/img.jpg"];
    [UIImagePNGRepresentation(image2) writeToFile:imagePath atomically:YES];
}

- (void)addMP4File{
    [self copyBundleToSanboxWithName:@"video" type:@"mp4"];
}
